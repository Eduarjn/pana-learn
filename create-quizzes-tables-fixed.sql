-- Script corrigido para criar tabelas de quiz no Supabase Dashboard
...
-- Criar tabela de quizzes (usando categoria em vez de curso_id)
CREATE TABLE IF NOT EXISTS public.quizzes (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  categoria VARCHAR(100) NOT NULL, -- Usar categoria em vez de curso_id
