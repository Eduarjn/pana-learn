-- Script completo para sistema de Quiz e Certificados
...
-- ========================================
-- 7. FUNÇÃO PARA GERAR NÚMERO DE CERTIFICADO
-- ========================================
...
BEGIN
  LOOP
    cert_number := 'CERT-' || TO_CHAR(NOW(), 'YYYYMMDD') || '-' || LPAD(counter::TEXT, 4, '0');
    
    -- Verificar se o número já existe
    IF NOT EXISTS (SELECT 1 FROM public.certificados WHERE numero_certificado = cert_number) THEN
      RETURN cert_number;
    END IF;
