-- Script COMPLETO para criar sistema de Quiz e Certificados
...
-- ========================================
-- 5. CRIAR TABELA CERTIFICADOS (atualizada)
-- ========================================
...
-- Inserir quiz para categorias básicas
...
COMMENT ON COLUMN public.certificados.link_pdf_certificado IS 'URL do PDF do certificado gerado';
