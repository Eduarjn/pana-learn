-- Script FINAL corrigido para sistema de Quiz e Certificados
-- Baseado na estrutura real da tabela cursos
...
DROP POLICY IF EXISTS "Admins podem gerenciar certificados" ON public.certificados;
...
-- Inserir quiz para categorias existentes (baseado nos dados reais da tabela cursos)
...
-- Verificar categorias dos cursos existentes
SELECT 'Categorias dos cursos existentes:' as info;
SELECT DISTINCT categoria FROM public.cursos WHERE categoria IS NOT NULL;
