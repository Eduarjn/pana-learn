-- Script FINAL do sistema de Quiz e Certificados
-- Agora que a coluna categoria existe na tabela cursos, este script vai funcionar!
...
-- Inserir quiz para categorias existentes na tabela cursos
INSERT INTO public.quizzes (categoria, titulo, descricao, nota_minima)
SELECT DISTINCT 
  categoria, 
  'Quiz de Conclusão - ' || categoria, 
  'Quiz para avaliar o conhecimento sobre ' || categoria, 
  70
FROM public.cursos 
...
SELECT 'Categorias dos cursos:' as info;
