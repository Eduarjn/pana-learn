  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md mx-auto relative">
        ...
        <h2 className="text-xl font-bold mb-4 text-era-dark-blue">Editar Certificado</h2>
        ...
        <div className="flex gap-2 mt-6">
          <Button className="bg-era-lime text-era-dark-blue font-bold flex-1" onClick={onSave}>Salvar</Button>
