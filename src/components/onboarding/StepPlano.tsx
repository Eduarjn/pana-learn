...
const PLANOS = [
  {
    ...
    features: ['Até 50 usuários', 'Vídeos + PDFs + Quizzes', 'Certificados', 'Suporte por e-mail'],
    destaque: false,
  },
  {
    id: 'pro',
    ...
    features: ['Usuários ilimitados', 'White-label completo', 'IA integrada', 'Suporte prioritário', 'API de integração'],
    destaque: true,
  },
  {
    id: 'enterprise',
    ...
    features: ['Tudo do Pro', 'SLA garantido', 'Gerente de conta', 'Integrações custom', 'Onboarding dedicado'],
    destaque: false,
  },
];
