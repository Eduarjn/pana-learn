        ...
        <div className="mb-4">
          <Card className="bg-yellow-50 border-yellow-200">
            <CardContent className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 p-4">
              <div className="text-yellow-800 font-medium">Lembrete: Você tem cursos em andamento! Não se esqueça de concluir para receber seu certificado.</div>
              <Button variant="outline" className="border-yellow-400 text-yellow-800 hover:bg-yellow-100" onClick={() => navigate('/treinamentos')}>Ver meus cursos</Button>
            </CardContent>
          </Card>
        </div>
        {/* Links rápidos */}
        <div className="flex flex-wrap gap-4 mb-4">
          <Button variant="outline" onClick={() => navigate('/relatorios')}>Relatórios</Button>
          <Button variant="outline" onClick={() => navigate('/dashboard')}>Estatísticas</Button>
          <Button variant="outline" onClick={() => navigate('/treinamentos')}>Próximos Treinamentos</Button>
        </div>
